...
/* KddeEdbBundle:PertinenceArea:modalNewPertinenceArea.html.twig */
class __TwigTemplate_25259a398ac27a3b48f662d659c251fa extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"modal hide\" id=\"modalNewPertinenceArea\">
\t<div class=\"modal-header\">
\t\t";
        // line 4
        echo "\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\">x</button>
\t\t<h3>Add New Pertinence Area</h3>
\t</div>
\t<div class=\"modal-body\">
\t\t<p>
\t\t\t<form class=\"form-horizontal\">
\t\t\t\t<fieldset>
\t\t\t\t\t<div id=\"divPertinenceArea\" class=\"control-group\">
\t\t\t\t\t\t<label style=\"text-align: left\" class=\"control-label\">Description</label> 
\t\t\t\t\t\t<div class=\"controls\">
\t\t\t\t\t\t\t<input id=\"inputPertinenceAreaDescription\" type=\"text\" 
\t\t\t\t\t\t\t\tonchange=\"\$('#divPertinenceArea').attr('class', 'control-group'); \$('#errorValPertinenzaArea').html(null)\">
\t\t\t\t\t\t\t<p class=\"help-block\" id=\"errorValPertinenzaArea\"></p>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"control-group\">
\t      \t\t\t\t<div class=\"controls\">
\t\t\t\t\t\t\t<a class=\"btn btn-primary\" id=\"addPertinenceArea\">Add</a>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t</fieldset>
\t\t\t</form>
...
\t
    ...
    {
        return "KddeEdbBundle:PertinenceArea:modalNewPertinenceArea.html.twig";
    }
