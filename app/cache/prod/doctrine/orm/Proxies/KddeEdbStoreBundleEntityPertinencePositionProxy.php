 ...
 */
class KddeEdbStoreBundleEntityPertinencePositionProxy extends \Kdde\EdbStoreBundle\Entity\PertinencePosition implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'description', 'pertinenceContext');
    }
